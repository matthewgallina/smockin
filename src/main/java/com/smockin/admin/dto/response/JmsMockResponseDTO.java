...
public class JmsMockResponseDTO extends JmsMockDTO {
    ...
    public JmsMockResponseDTO(final String extId, final String userCtxPath, final String name, final RecordStatusEnum status, final JmsMockTypeEnum mockType, final Date dateCreated) {
