app.controller('sseSendMessageController', function($scope, $timeout, $http, restClient, $uibModalInstance, globalVars, utils, data) {
    ...
    //
    // Labels
    $scope.clientHeading = "Push SSE Message" + ((data.sessionId == null) ? " (All Clients)" : "");
   ...
   function showAlert(msg, type) {
    ...
    $scope.doPushMessage = function() {
        ...
        var url = '/sse' + ((data.sessionId != null) ? '/' + data.sessionId : '');
